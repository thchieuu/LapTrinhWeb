...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="cssAdmin/abut_calendar.css">
              ...
              <div class="row">
                 ...
                 <!-- 	<div class="row mtbox">
					...
					<div class="row">
						...
						<div class="col-md-4 mb">
							<!-- INSTAGRAM PANEL -->
							<div class="instagram-panel pn" style="background: #444c57">
...
-->
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <a href="ad_index.html#" class="go-top">
